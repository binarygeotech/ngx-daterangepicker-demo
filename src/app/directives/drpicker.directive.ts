...
import { DaterangepickerComponent, LocaleConfig, LocaleService } from 'ngx-daterangepicker-material';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import * as _moment from 'moment';
const moment = _moment;

@Directive({
  selector: '[ngxDaterangepickerMd-DR]',
  host: {
    '(keyup.esc)': 'hide()',
    '(blur)': 'onBlur()',
    '(click)': 'open()'
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => DRPickerDirective), multi: true
    }
]
})
export class DRPickerDirective implements OnInit, OnChanges, DoCheck {
